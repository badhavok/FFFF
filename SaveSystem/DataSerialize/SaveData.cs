...
public class SaveData
{
	...
	private const int DEFAULT_SHIPPARTS = 0;
	private const int DEFAULT_HE_SHIPPARTS = 0;
	#endregion

	// We initialize all of the stats to be default values.
	public int coins = DEFAULT_DIAMONDS;
	public int health = DEFAULT_SHIPPARTS;
	public int lives = DEFAULT_HE_SHIPPARTS;
	...
	{
		return (
			coins == DEFAULT_DIAMONDS &&
			health == DEFAULT_SHIPPARTS &&
			lives == DEFAULT_HE_SHIPPARTS &&
